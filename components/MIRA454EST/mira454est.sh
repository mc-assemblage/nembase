...
mira --project=mira --job=denovo,est,accurate,454 COMMON_SETTINGS -GE:not=$threads -DI:cwd=$basepath -MI:sonfs=no 454_SETTINGS -CL:qc=no$SSAHA2OPT -FN:fqi=$fastqfile -LR:mxti=no
